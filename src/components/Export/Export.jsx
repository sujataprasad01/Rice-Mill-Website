...
import Lachkari from '../../assets/survices/20240116_101620.jpg';
...
Length: 6-7 mm<br/><br/>Experience the Perfect Blend of Nutrient-Rich Parboiled Goodness in Every Grain of IR 64.</p>
                ...
                <div className="service_box">
                <div className="service_imgtwo"><img src={Lachkari}></img></div>
...
<br/>Versatile Delight: Lachkari Kolam, a Symphony of Taste Available in Both Raw and Steam Varieties.</p>
                        {/* <a href="/" className="read">Read more</a> */}
                    </div>
                </div>
                <div className="service_box">
                <div className="service_imgthree"><img src={Kali}></img></div>
