...
function Manufacture() {
  return (
       <>
        <div  className='hero'>
  <div className='description'><h3>Cleaning and Dehusking:</h3><br/><br/><br/><p>Raw paddy rice is fed into the machine.<br/>
...
<div  className='hero'>
  <div className='description'><h3>Separation of Husk and Brown Rice:</h3><br/><br/><br/><p>After dehusking, the mixture of brown rice and husk is separated.<br/>
...
<div  className='hero'>
  <div className='description'><h3>Whitening or Polishing:</h3><br/><br/><br/><p>The brown rice, still covered with bran layers, undergoes whitening or polishing.<br/>
...
<div className='herooneee'><img src={Herothree}></img></div>
    ...
    <div  className='hero'>
  <div className='description'><h3>Separation of Broken Rice:</h3><br/><br/><br/><p>Rice grains can break during the milling process. A separator is used to <br/>separate broken rice from whole grains.</p></div>
<div className='herooneeee'><img src={Herofour}></img></div>
    </div>
    <div  className='hero'>
  <div className='description'><h3>Grading and Sorting:</h3><br/><br/><br/><p>The machine grades and sorts the polished rice based on size and quality.<br/>
...
<div className='herooneeeee'><img src={Herofive}></img></div>
    ...
    <div  className='hero'>
  <div className='description'><h3>Packaging:</h3><br/><br/><br/><p>The final polished and graded rice is then ready for packaging.<br/>
The packaging process may be integrated into the rice mill or done as a separate operation.</p></div>
<div className='heroonee'><img src={Herosix}></img></div>
    </div>
    </>
// </div>
  )
